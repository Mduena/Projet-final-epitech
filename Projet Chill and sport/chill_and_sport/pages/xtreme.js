...
export default function ListActivities(props) {
    ...
    async function pagination(value)
    {
        ...
        //axios.get(`http://localhost:3000/api/activity/get_activities?begin=${value}&end=${value+maxItems}`).then((res) => {

          axios.get(`http://localhost:3000/api/category/activity/6334458225d9e17b7bf5fa21?begin=${value}&end=${value+maxItems}&date_debut=${toDay}`).then((res) => {
          // console.log(res);
                                    ...
                                    <div className="p-10 mb-10 bg-gray-100 rounded-2xl mt-10 mb-10 ">
                                            <div class="grid grid-rows-3 grid-flow-col gap-4 ">
                                               ...
                                               <img src={act.photo} alt={act.title} className="row-span-3 h-40 w-60 object-cover object-center group-hover:opacity-75 rounded" />
                                                ...
                                                <p className=" row-span-2 col-span-2 text-xl mt-1 text-lg font-medium text-gray-900">{act.description}</p> <br></br>
                                                {
                                                    dateStr &&
